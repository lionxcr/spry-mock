...
class OrderHistory{
    constructor(){
        this.orderHistory = [
            new orderStatus("Working on Order", "completed", false, "Currently we are working on your request, we carefully review the brief, do research and then start writing.",1,"Order developed"),
