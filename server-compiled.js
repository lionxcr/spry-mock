...
var OrderHistory = function OrderHistory() {
    ...
    this.orderHistory = [new orderStatus("Working in Order", "comple", false, "Currently we are working on your request, we carefully review the brief, do research and then start writing.", 1, ""), new orderStatus("Provide Feedback", "in_progress", true, "Review the work", 20, "Feedback submitted "), new orderStatus("Working on Feedback", "pending", false, "We are making some changes", 25, "Feedback developed"), new orderStatus("Deliver Order", "pending", false, "", 30, "Order delivered")];
};

var FreelancerOrder = function FreelancerOrder() {
    _classCallCheck(this, FreelancerOrder);

    this.orderHistory = [new orderStatus("Quick quality check", "completed", true, "We did our standard quality check.", 1, "See what we think"), new orderStatus("Client Review", "in_progress", true, "Review the work", 85, "Feedback submitted"), new orderStatus("Work on Feedback", "pending", false, "We are making some changes", 145, "Feedback developed"), new orderStatus("Finish Order", "pending", false, "", 205, "Order delivered")];
};
